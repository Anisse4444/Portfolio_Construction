...
def get_ind_file(filetype, weighting="vw", n_inds=30):
    ...
    ind = pd.read_csv(f"/Users/anisse/Library/Mobile Documents/com~apple~CloudDocs/Documents/Research/PYTHON - Prtf optimization/data/ind{n_inds}_m_{name}.csv", header=0, index_col=0, na_values=-99.99)/divisor
